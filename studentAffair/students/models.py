...
class Student(models.Model):
    ...
    fname = models.CharField(max_length = 50, null=False,default='First name', verbose_name='First Name')
    lname = models.CharField(max_length = 50, default='Last name', verbose_name='Last Name')
    id = models.CharField(max_length=8,primary_key=True, unique=True,error_messages ={"unique":"The ID you entered is not unique."},default='20210000', verbose_name='ID')
    ...
    departement = models.CharField(max_length=4,default='NULL',null=True, choices=[('NULL','NULL'),('CS','CS'),('AI','AI'),('IS','IS'),('IT','IT'),('DS','DS')])
